...
(function ($) {
	...
	$.widget("wijmo.wijmenu", {
		options: {
			/// <summary>
			///web.archive.org/web/20130724021647/http://an jQuery selector which handle to open the menu or submenu.
			///web.archive.org/web/20130724021647/http://default"".
			///web.archive.org/web/20130724021647/http://Type:String.
			///web.archive.org/web/20130724021647/http://Remark:If set to the menu item(the li element) then when it is clicked
			///(if the triggerEvent set to 'click') show ubmenu.If set to a element out
			///web.archive.org/web/20130724021647/http://of the menu ,click(if the triggerEvent set to 'click') it,open the menu. 
			///</summary>
			trigger: '',
			/// <summary>
			///web.archive.org/web/20130724021647/http://specifies the event to show the menu.
			///web.archive.org/web/20130724021647/http://default"click".
			///web.archive.org/web/20130724021647/http://Type:String.
			///web.archive.org/web/20130724021647/http://Remark:The value can be seted to 'click','mouseenter','dbclick','rtclick'
			///</summary>
			triggerEvent: 'click',
			///<summary>
			///web.archive.org/web/20130724021647/http://location and Orientation of the menu,relative to the button/link userd
			/// to open it. Configuration for the Position Utility,Of option
			///web.archive.org/web/20130724021647/http://excluded(always configured by widget).Collision also controls collision 
			///web.archive.org/web/20130724021647/http://detection automatically too.
			///web.archive.org/web/20130724021647/http://default{}.
			///web.archive.org/web/20130724021647/http://Type:Object.
			///</summary>
			position: {},
			///<summary>
			///web.archive.org/web/20130724021647/http://sets showAnimated and hideAnimated if not specified individually.
			///web.archive.org/web/20130724021647/http://default"slide".
			///web.archive.org/web/20130724021647/http://Type:String.
			///web.archive.org/web/20130724021647/http://Remark:Users standard animation setting syntax from other widgets.
			///</summary>
			animated: 'slide',
			///<summary>
			///web.archive.org/web/20130724021647/http://determines the animationn used during show.
			///web.archive.org/web/20130724021647/http://default"slide".
			///web.archive.org/web/20130724021647/http://Type:String.
			///web.archive.org/web/20130724021647/http://Remark:This option uses the standard animation setting syntax from
			/// other widgets.
			///</summary>
			showAnimated: null,
			/// <summary>
			///web.archive.org/web/20130724021647/http://determines the animation used during hide.
			///web.archive.org/web/20130724021647/http://default"slide".
			///web.archive.org/web/20130724021647/http://Type:String.
			///web.archive.org/web/20130724021647/http://Remark:Users standard animation setting syntax from other widgets.
			///</summary>
			hideAnimated: null,
			///<summary>
			///web.archive.org/web/20130724021647/http://determines the speed to show/hide the menu in milliseconds.
			/// Sets showDuration and hideDuration if they are not specified.
			///web.archive.org/web/20130724021647/http://Default:400.
			///web.archive.org/web/20130724021647/http://Type:Number.
			///</summary>
			duration: 400,
			///<summary>
			///web.archive.org/web/20130724021647/http://determines the speed to show the menu,in milliseconds.
			///web.archive.org/web/20130724021647/http://Default:null.
			///web.archive.org/web/20130724021647/http://Type:Number.
			///</summary>
			showDuration: null,
			///<summary>
			///web.archive.org/web/20130724021647/http://determines the speed to hide the menu,in milliseconds.
			///web.archive.org/web/20130724021647/http://Default:null.
			///web.archive.org/web/20130724021647/http://Type:Number.
			///</summary>
			hideDuration: null,
			///<summary>
			///web.archive.org/web/20130724021647/http://defines the behavior of the submenu whether it is a popup 
			///web.archive.org/web/20130724021647/http://menu or an iPod-style navigation list.
			///web.archive.org/web/20130724021647/http://default"flyout".
			///web.archive.org/web/20130724021647/http://Type:String.
			///web.archive.org/web/20130724021647/http://Remark:The value should be "flyout" or "sliding".
			///</summary>
			mode: 'flyout',
			///<summary>
			///web.archive.org/web/20130724021647/http://this option specifies a hash value that sets to superpanel options 
			///web.archive.org/web/20130724021647/http://when a superpanel is created.
			///web.archive.org/web/20130724021647/http://Default:null.
			///web.archive.org/web/20130724021647/http://Type:Object.
			///</summary>
			...
			///web.archive.org/web/20130724021647/http://Default:false.
			///web.archive.org/web/20130724021647/http://Type:Boolean.
			///</summary>
			checkable: false,
			///<summary>
			///web.archive.org/web/20130724021647/http://controls the root menus orientation. All submenus are vertical 
			///web.archive.org/web/20130724021647/http://regardless of the orientation of the root menu.
			///web.archive.org/web/20130724021647/http://default"horizontal".
			///web.archive.org/web/20130724021647/http://Type:String.
			///web.archive.org/web/20130724021647/http://Remark:The value should be "horizontal" or "vertical".
			///</summary>
			orientation: 'horizontal',
			///<summary>
			///web.archive.org/web/20130724021647/http://determines the i-Pod-style menu's maximum height.
			///web.archive.org/web/20130724021647/http://Default:200.
			///web.archive.org/web/20130724021647/http://Type:Number.
			///web.archive.org/web/20130724021647/http://Remark:This option only used in i-pod style menu. when the menu's heiget 
			///web.archive.org/web/20130724021647/http://largger than this value,menu show scroll bar.
			///</summary>
			maxHeight: 200,
			/// <summary>
			///web.archive.org/web/20130724021647/http://determines whether the i-Pod menu shows a back link or a breadcrumb header
			/// in the menu.
			///web.archive.org/web/20130724021647/http://Default:true.
			///web.archive.org/web/20130724021647/http://Type:Boolean.
			///</summary>
			backLink: true,
			///<summary>
			///web.archive.org/web/20130724021647/http://sets the text of the back link.
			///web.archive.org/web/20130724021647/http://default"Back".
			///web.archive.org/web/20130724021647/http://Type:String.
			///</summary>
			backLinkText: 'Back',
			///<summary>
			///web.archive.org/web/20130724021647/http://sets the text of the top link.
			///web.archive.org/web/20130724021647/http://default"All".
			///web.archive.org/web/20130724021647/http://Type:String.
			///</summary>
			topLinkText: 'All',
			///<summary>
			///web.archive.org/web/20130724021647/http://sets the top breadcrumb's default Text.
			///web.archive.org/web/20130724021647/http://default"Choose an option".
			///web.archive.org/web/20130724021647/http://Type:String.
			///</summary>
		...
		activate: function (event, item) {
			...
			///web.archive.org/web/20130724021647/http://scrolling the new one into view,if necessary,making it the active item,
			///web.archive.org/web/20130724021647/http://and triggering a focus event.</summary>
		...
		previous: function (event) {
			...
			///web.archive.org/web/20130724021647/http://last item if none is active or if the first one is active.</summary>
			/// <param name="event" type="Event">The javascript event.</param>
		...
		last: function () {
			...
			///web.archive.org/web/20130724021647/http://last menu item</summary>
			/// <returns type="Boolean" />
			var active = this.element.data("activeItem");
		...
		nextPage: function (event) {
			...
			///web.archive.org/web/20130724021647/http://but it jumps a whole page.</summary>
			/// <param name="event" type="Event">The javascript event.</param>
		...
		select: function (event) {
			...
			///web.archive.org/web/20130724021647/http://item. This event is useful for custom keyboard handling.</summary>
			/// <param name="event" type="Event">The javascript event.</param>
			var active = this.element.data("activeItem");
		...
		///web.archive.org/web/20130724021647/http://set options
		...
		_initTrigger: function (triggerEle) {
			...
			$(document).bind("click.wijmenudoc", function (e) {
				...
				///web.archive.org/web/20130724021647/http://fixed when click the breadcrumb choose item link to show
		...
		refresh: function () {
			...
			///web.archive.org/web/20130724021647/http://call this method whenever adding or replaceing items in the menu via DOM
			///web.archive.org/web/20130724021647/http://operations,for example,via menu.append
		...
		_flyout: function () {
			...
			///web.archive.org/web/20130724021647/http://when click the menu item hide the submenus.
							...
							if (footer.find('a').size() === 0) {
								...
								'-1-w"></span> <span>' + o.backLinkText + '</span></a>')
									...
									.click(function () { // ----- show the previous menu
										...
										///web.archive.org/web/20130724021647/http://to fix click the back button too quickly.
										///web.archive.org/web/20130724021647/http://the menu display wrong.
		...
		///web.archive.org/web/20130724021647/http://popup menu
		//		_popup: function () {
		//			var self = this;
		//			var o = self.options;
...
/*
     FILE ARCHIVED ON 02:16:47 Jul 24, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:00:57 Mar 22, 2026.
...
playback timings (ms):
  ...
  esindex: 0.027
  cdx.remote: 135.43
  LoadShardBlock: 314.976 (3)
  PetaboxLoader3.datanode: 313.87 (4)
  load_resource: 353.025
  PetaboxLoader3.resolve: 199.569
*/