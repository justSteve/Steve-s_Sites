...
var windowOnload = function(){
	...
	try{
		if(document.createStyleSheet) {
			document.createStyleSheet('https://web.archive.org/web/20081031130234/https://newchat.livehelper.com/Client_Chat/pullDiv.css');
		}else{
			var styles="@import url('https://web.archive.org/web/20081031130234/https://newchat.livehelper.com/Client_Chat/pullDiv.css');";
...
function endPull(){
	...
	frameval.postMessage("endchat","https://web.archive.org/web/20081031130234/https://newchat.livehelper.com");
	pullStat = false;
	hidePull();
...
function pullOut(){
	var frameval=document.getElementById("Pull_Iframe_Client_Live").contentWindow;
	frameval.postMessage("pullout","https://web.archive.org/web/20081031130234/https://newchat.livehelper.com");
	pullStat = false;
	hidePull();
...
function minPull(){
	...
	if(PullIframe){
		...
		mmig.src='https://web.archive.org/web/20081031130234/https://newchat.livehelper.com/Client_Chat/maximize.jpg';		
	}
	resizetrack = true;
}
function maxPull1(){
...
function maxPull(){
	...
	if(PullIframe){
		...
		mmig.src='https://web.archive.org/web/20081031130234/https://newchat.livehelper.com/Client_Chat/minimize.JPG';		
	}
	resizetrack = false;	
}
function pullResize(){
...
defaultImage.src = "https://web.archive.org/web/20081031130234/https://www.livehelper.com/images4/logo9].gif";
function LHBtnMsgQ(){
	var rnd =  Math.random();
	var pageVisit = "true";
	var based = null;
										   ...
										   '<table width="100%" height="5" border="0">'+
												'<tr>'+
									              '<td width="16" height="16" align="center" valign="top">'+
												  	'<img src="https://web.archive.org/web/20081031130234/https://newchat.livehelper.com/Client_Chat/green_icon.JPG" width="16" height="16" />'+
												  '</td>'+
												  ...
												  '<td width="31" align="center" valign="top">'+
													'<a href="#" onclick="pullOut();"><img src="https://web.archive.org/web/20081031130234/https://newchat.livehelper.com/Client_Chat/popout.JPG" width="15" height="15" border="0"  alt="Pop out" /></a>'+
												  '</td>'+
												  '<td width="16" align="left" valign="top" >'+
													'<a href="#" onclick="pullResize();"><img src="https://web.archive.org/web/20081031130234/https://newchat.livehelper.com/Client_Chat/minimize.JPG" alt="Minimize" width="17" height="14" border="0" id="mmig"/></a>'+
												  '</td>'+
												  '<td width="19" align="left" valign="top">'+
													'<a href="#" onclick="endPull();"><img src="https://web.archive.org/web/20081031130234/https://newchat.livehelper.com/Client_Chat/close.jpg" alt="Close" width="14" height="13" border="0" /></a>'+
												  '</td>'+
												'</tr>'+
										'</table>'+
									  '</div>'+
...
/*
     FILE ARCHIVED ON 13:02:34 Oct 31, 2008 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:56:42 Mar 22, 2026.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 22.237
  LoadShardBlock: 206.402 (3)
  PetaboxLoader3.datanode: 108.007 (4)
  PetaboxLoader3.resolve: 475.374 (3)
  load_resource: 468.692
*/